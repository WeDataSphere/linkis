...
object Configuration extends Logging {
  ...
  val SECONDARY_QUEUE_ENABLED: CommonVars[Boolean] = CommonVars.apply("wds.linkis.rm.secondary.yarnqueue.enable", false)
  ...
  val SECONDARY_QUEUE_THRESHOLD: CommonVars[Double] = CommonVars.apply("wds.linkis.rm.secondary.yarnqueue.threshold", 0.9)
  ...
  val SECONDARY_QUEUE_ENGINES: CommonVars[String] = CommonVars.apply("wds.linkis.rm.secondary.yarnqueue.engines", "spark")
  ...
  val SECONDARY_QUEUE_CREATORS: CommonVars[String] = CommonVars.apply("wds.linkis.rm.secondary.yarnqueue.creators", "IDE")
