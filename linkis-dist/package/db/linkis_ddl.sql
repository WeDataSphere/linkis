...
CREATE TABLE IF NOT EXISTS `linkis_ps_ai_job_history` (
    ...
    `change_time` DATETIME DEFAULT CURRENT_TIMESTAMP(3) COMMENT '切换时间',
    `created_time` DATETIME DEFAULT CURRENT_TIMESTAMP(3) COMMENT '创建时间',
    `updated_time` DATETIME DEFAULT CURRENT_TIMESTAMP(3) COMMENT '更新时间'
