...
export default {
  ...
  methods: {
    ...
    onConnectTestFromVersion(data){
      if (typeof data.versionId == "undefined"){
        this.$Message.warning(this.$t('message.linkis.datasource.undefinedVersion'))
      }
    ...
    onConnectTest(data){
      this.currentSourceData = data;
      if (typeof this.currentSourceData.versionId == "undefined"){
        this.$Message.warning(this.$t('message.linkis.datasource.undefinedVersion'))
      }
