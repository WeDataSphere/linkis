...
public enum LinkisConfigurationErrorCodeSummary implements LinkisErrorCode {
  ...
  ONLY_ADMIN_CAN_GET(14100, "Only admin can query data(只有管理员才能查询数据)"),
  ONLY_ADMIN_CAN_POST(14100, "Only admin can modify data(只有管理员才能修改数据)"),
  ONLY_ADMIN_CAN_DELETE(14100, "Only admin can delete data(只有管理员才能删除数据)"),
