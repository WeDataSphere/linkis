...
public interface JobHistoryQueryService {
    ...
    List<JobHistory> search(Long jobId, String username, String creator, String status, Date sDate, Date eDate, String engineType, Long startJobId, String instance, String ecmInstance);
