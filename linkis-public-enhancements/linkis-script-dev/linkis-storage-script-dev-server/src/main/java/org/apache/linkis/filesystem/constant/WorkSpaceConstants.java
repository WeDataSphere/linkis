...
public class WorkSpaceConstants {
  ...
  public static final String FILEPATH_ILLEGALITY = "File path illegality : {0} （文件路径不合法 : {0}）";
  public static final String PERMISSION_FORMAT_ERROR = "Permission format error {0}（权限格式错误 {0}）";
}
